...
require.config({ // Configure RequireJS.
	...
	deps: Object.keys(window.__karma__.files) // Dynamically load all test files
	...
	callback: window.__karma__.start // we have to kickoff jasmine, as it is asynchronous
});
